...
import tmg.utilities.lifecycle.mvvm.MVVMViewModel

//region Inputs

interface AboutThisAppVMInputs {
    fun setupLinks(github: String? = null, website: String? = null, email: String? = null, play: String? = null, appPackage: String? = null)
